...
| `/dev-review 组件影响 <name or path>` | Before changing a shared component | Reverse-maps every consumer from code (card cross-checked); impact list + per-consumer regression hints; can generate a 组件变更 requirement (待审核) |
