...
只修作者已写进「缺陷记录」的条目 / only fix bugs the author already logged in the doc；不要替作者编写 BUG 文档，找不到就问 / never author a bug doc yourself。修完补「整改」「根因」并汇入模块卡「缺陷史」 / fill 整改 + 根因 and append to the module card 缺陷史。
